...
class CFilter {
	...
	function markdown($text) {
		require_once(dirname(dirname(dirname(__FILE__))). '/php-markdown/Michelf/Markdown.php');
		require_once(dirname(dirname(dirname(__FILE__))). '/php-markdown/Michelf/MarkdownExtra.php');
