...
<div id="content">
	...
	<p>Momentet var väldigt enkelt då jag tidigare har syslat med HTML och webbutveckling.<br>
	...
	<p>Känns även bra att man redan nu lär ut principen att dela upp sidan i flera bitar (Header, Main, Footer etc.). 
		Detta leder till större återanvändbarhet av kod samt att man miskar tiden vid underhåll av sidan, 
		man behöver endast ändra på ett ställe för att ändra header/footer, 
		man slipper gå igenom och ändra på varje sida.</p>
	<p>Har syslat med HTML/CSS/PHP/MySQL de senaste 10 åren, vilket gör att jag skulle säga att jag är erfaren.</p>
	...
	<p>Har syslat med HTML/CSS/PHP/MySQL i olika omfattning de senaste 10 åren, vilket gör att jag skulle säga att jag är erfaren.</p>
